...
st.set_page_config(page_title="Assinatura de Holerites Polo PR", page_icon="logo.png")
...
SPREADSHEET_ID = '18mCZTru5UZ-r55jU1XrpXOnET1w2oHvoa1huphOE0sg'
RANGE_NAME = 'A1:K'
...
st.markdown("<h1 style='text-align: center;'>📄 Assinatura de Holerites Polo PR</h1>", unsafe_allow_html=True)
